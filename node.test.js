...
(function ($) {
    class $mpk_tss_pereferials extends $.$mpk_tss_wrap {
        ...
        column_names() {
            return [].concat(this.column_type(), this.column_element(), this.column_status(), this.column_action());
        }
        column_type() {
            return this.$.$mol_locale.text("$mpk_tss_pereferials_column_type");
        }
        column_element() {
            return this.$.$mol_locale.text("$mpk_tss_pereferials_column_element");
        }
        column_status() {
            return this.$.$mol_locale.text("$mpk_tss_pereferials_column_status");
        }
        column_action() {
            return this.$.$mol_locale.text("$mpk_tss_pereferials_column_action");
        }
        sub() {
        ...
        Unit_card(index) {
            return ((obj) => {
                obj.unit = () => this.unit(index);
                obj.arg = () => this.unit_arg(index);
                return obj;
            })(new this.$.$mpk_tss_pereferials_unit);
        }
        unit(index) {
            return null;
        }
...
(function ($) {
    class $mpk_tss_pereferials_unit extends $.$mol_link {
        unit() {
            return null;
        }
        minimal_height() {
    ...
    __decorate([
        $.$mol_mem
    ], $mpk_tss_pereferials_unit.prototype, "Card", null);
    $.$mpk_tss_pereferials_unit = $mpk_tss_pereferials_unit;
})($ || ($ = {}));
(function ($) {
    class $mpk_tss_pereferials_unit_card extends $.$mol_card {
        ...
        Footer() {
            return ((obj) => {
                obj.minimal_height = () => 30;
                obj.sub = () => [].concat(this.Status_text(), this.Refresh_action());
                return obj;
            })(new this.$.$mol_view);
        }
        Status_text() {
            return ((obj) => {
                obj.sub = () => [].concat(this.status());
                return obj;
            })(new this.$.$mol_view);
        }
        Refresh_action() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Refresh_icon());
                return obj;
            })(new this.$.$mol_button_minor);
        }
        Refresh_icon() {
        ...
        items() {
            return [].concat(this.Type_item(), this.Element_item());
        }
        Type_item() {
            return ((obj) => {
        ...
        Element_item() {
            return ((obj) => {
                obj.title = () => this.element_title();
                obj.content = () => this.element();
                return obj;
            })(new this.$.$mol_labeler);
        }
        element_title() {
...
(function ($) {
    class $mpk_tss_reports extends $.$mpk_tss_wrap {
        ...
        body() {
            return [].concat(this.Filter_title(), this.Results());
        }
        Filter_title() {
            return ((obj) => {
                obj.query = (val) => this.filter_title(val);
    ...
    __decorate([
        $.$mol_mem
    ], $mpk_tss_reports.prototype, "Results", null);
...
var $;
(function ($) {
    class $mpk_tss extends $.$mol_book {
        Menu_item(id) {
            return ((obj) => {
        ...
        pages() {
            return [].concat(this.Sidebar(), this.Summary(), this.search(), this.menu_pages());
        }
        Sidebar() {
            return ((obj) => {
                obj.head = () => [].concat(this.Logo());
                obj.title = () => this.$.$mol_locale.text("$mpk_tss_Sidebar");
        ...
        breadcrumbs() {
            return [].concat(this.main_title());
        }
        main_title() {
            return this.$.$mol_locale.text("$mpk_tss_main_title");
        }
        User_link() {
            return ((obj) => {
                obj.event_click = (val) => this.logout_click(val);
                obj.sub = () => [].concat(this.User_email(), this.User_signout());
                return obj;
            })(new this.$.$mol_button_minor);
        }
        logout_click(val, force) {
            return (val !== void 0) ? val : null;
        }
        User_email() {
            return ((obj) => {
    ...
    __decorate([
        $.$mol_mem_key
    ], $mpk_tss.prototype, "Menu_item", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Software", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Pereferials", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Sensors", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Reports", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Enter", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "entered", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "logged_email", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Sidebar", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Logo", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "event_top", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Menu", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Foot_content", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Foot_text", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Summary", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "User_link", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "logout_click", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "User_email", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "User_signout", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Details_close", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Details_close_icon", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Placeholder", null);
    __decorate([
        $.$mol_mem
    ], $mpk_tss.prototype, "Image", null);
    $.$mpk_tss = $mpk_tss;
})($ || ($ = {}));
