...
declare namespace $ {
    function $mol_dom_render_children(el: Element, childNodes: NodeList | Array<Node | string>): void;
}
declare namespace $ {
...
declare namespace $ {
    ...
    class $mol_view extends $mol_object {
        static readonly Root: Record<number, $mol_view>;
...
declare namespace $ {
    class $mol_fetch extends $mol_object2 {
        ...
        static response(input: RequestInfo, init?: RequestInit): Response;
        ...
        static buffer(input: RequestInfo, init?: RequestInit): any;
